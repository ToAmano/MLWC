import numpy as np
import pytest
from src.mlwc.fourier.autocorrelation import autocorr, autocorr_numpy, autocorr_scipy, autocorr_statsmodels

EXPECTED = np.array([ 2. ,  0.8, -0.2, -0.8, -0.8])
...
def test_autocorr_numpy_compute_autocorr1d_even():
    ...
    x = np.array([1, 2, 3, 4, 5, 6])
    result = autocorr_numpy.compute_autocorr1d(x=x)
    expected = np.array([ 2.91666667,  1.45833333,  0.16666667, -0.79166667, -1.25, -1.04166667]) 
    assert np.allclose(result, expected)
...
def test_autocorr_numpy_compute_autocorr2d_ifmean_false():
    ...
    expected = np.array([[-1.125, -1.125, -1.125],
                         [ 2.25 ,  2.25 ,  2.25 ],
                         [-1.125, -1.125, -1.125]])
    print(f"result={result}")
    assert np.allclose(result, expected)
...
def test_autocorr_statsmodels_compute_autocorr2d_ifmean_false():
    ...
    expected = np.array([[ 2.25,   2.25,   2.25 ],
                        [-1.125, -1.125, -1.125]])
    assert np.allclose(result, expected)
