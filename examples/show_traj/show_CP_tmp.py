...
# def Write_Traj(filename, JUMP=False):
#     '''
...
#     traj = Trajectory(filename+"_refine.traj") # reload as traj
...
import nglview as nv
from ase.io.trajectory import Trajectory
import show_traj.read_CP 



traj =  show_traj.read_CP.ReadCP2(filename)

view=nv.show_asetraj(traj.TRAJ)
