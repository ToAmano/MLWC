...
# save file in extended xyz
ase.io.write(file+"_refine.xyz",images=test,format="xyz")


    
from ase.io.trajectory import Trajectory
# save file in ase.traj
ase.io.write(file+"_refine.traj",test,format="traj")

# reload as traj
traj = Trajectory(file+"_refine.traj")
