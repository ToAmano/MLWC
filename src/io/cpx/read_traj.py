...
class ReadCP(io.read_core.custom_traj):
    '''
...
class ReadXDATCAR(io.read_core.custom_traj):
    '''
    input
...
class ReadPOS(io.read_core.custom_traj):
    '''
    ...
    def __init__(self, filename: str, pwin: str):
        ...
        # make atoms
        atoms_list = io.read_core.raw_make_atomslist(
