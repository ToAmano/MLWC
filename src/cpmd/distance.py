...
class distance_2d(distance_abstract):
    ...
    def compute_distances(cls,vector_array1:np.ndarray, vector_array2:np.ndarray,cell:np.ndarray, pbc:bool=True)->np.ndarray:
        ...
        Args:
            vector_array1 (np.ndarray): vectors array 1
            vector_array2 (np.ndarray): vectors array 2
...
class distance_matrix(distance_abstract):
    ...
    def compute_distances(cls,vector_array1: np.ndarray, vector_array2: np.ndarray, cell: np.ndarray, pbc: bool = True) -> np.ndarray:
        ...
        Args:
            vector_array1 (np.ndarray): 3D vectors array 1, expected to be [a, b, 3]
            vector_array2 (np.ndarray): 3D vectors array 2, expected to be [a, b, 3]
