...
class asign_wcs:
    ...
    def raw_calc_mu_bond_lonepair(self,wfc_list,ase_atoms,unit_cell_bonds):
        return raw_calc_mu_bond_lonepair(wfc_list,ase_atoms,unit_cell_bonds,self.NUM_MOL,self.UNITCELL_VECTORS)
...
#
# * 全てのwcsの割り当て
def raw_calc_mu_bond_lonepair(wfc_list,ase_atoms,unit_cell_bonds,NUM_MOL,UNITCELL_VECTORS) :
    '''
    ...
    '''
    # aseatomsから座標とBCを計算
    results=raw_aseatom_to_mol_coord_bc(ase_atoms,unit_cell_bonds) 
    #ワニエ中心を各分子に帰属する
    list_mol_coords,list_bond_centers = results
