...
class asign_wcs:
    ...
    def calc_mu_bond_lonepair(self, wfc_list,ase_atoms,unit_cell_bonds):
        return raw_calc_mu_bond_lonepair(wfc_list,ase_atoms,unit_cell_bonds,self.NUM_MOL_ATOMS,self.NUM_MOL,self.UNITCELL_VECTORS)
...
#
# * 全てのwcsの割り当て
def raw_calc_mu_bond_lonepair(wfc_list,ase_atoms,unit_cell_bonds,NUM_MOL_ATOMS,NUM_MOL,UNITCELL_VECTORS) :
    '''
