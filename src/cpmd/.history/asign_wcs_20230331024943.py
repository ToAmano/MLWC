...
def raw_find_lonepairs(atom_coord:np.array,wfc_list,wcs_num:int):
    '''
    ...
    atom_wan=raw_make_aseatoms_from_wc(atom_coord,wfc_list)
...
def find_bondwcs(atom_coord:np.array,wfc_list,wcs_num:int):
    '''
