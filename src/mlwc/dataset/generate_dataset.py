...
# read bondfile
ReadMolFile(bondfilename)

atoms = ase.io.read(filename, index=0)
itp_data = create_molecular_info(bondfilename)
...
# 記述子計算
descs_x = atoms_wan.DESC.calc_lonepair_descripter_at_frame_type2(
    atoms_wan.atoms_nowan,
    list_mol_coords,
    itp_data.atomic_index["o_list"],
    "allinone",
    4,
    6,
    24,
