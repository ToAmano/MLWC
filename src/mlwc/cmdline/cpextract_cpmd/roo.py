...
class ROO:
    ...
    def calc_roo(self):
        ...
        hydrogen_bond_list: np.ndarray = mlwc.fourier.hydrogenbond.calc_roo(
            self._traj, oxygen_list, self.NUM_MOL, self._NUM_ATOM_PER_MOL
        )
        ...
        # Data below:\n
        """
        to_csv_with_comment(df_acf, comment, self.__filename + "_roo_acf.csv")
        ...
        to_csv_with_comment(df_roo, comment, self.__filename + "_roo_ft.csv")
