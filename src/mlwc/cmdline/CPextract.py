...
from mlwc.cmdline.cpextract_cpmd import cpextract_cpmd
from mlwc.cmdline.cpextract_cpmd import roo,msd,vdos,angleoh,distance_ft
from mlwc.cmdline.cpextract_diel import histgram, plot, gfactor, dielconst,cpextract_diel
...
def parse_cml_args(cml):
    ...
    # cpextract cp dfset
    parser_cp_dfset = cp_sub_parsers.add_parser(
        'dfset', help='cp.x to dfset converter')
    ...
    # cpextract cp wf
    parser_cp_wf = cp_sub_parsers.add_parser(
        'wan', help='cp.x wf stdoutput parser')
    ...
    # * ------------
    # cpextract cpmd
    parser_cpmd = subparsers.add_parser(
        "cpmd", help="cpmd sub-command for CPMD.x")
    ...
    # cpextract cpmd xyz
    parser_cpmd_xyz = cpmd_sub_parsers.add_parser(
        'xyz', help='cpmd.x xyz parser')
  ...
  # cpextract cpmd addlattice
    ...
    parser_cpmd_addlattice.set_defaults(
        handler=cpextract_cpmd.command_cpmd_addlattice)
    ...
    parser_diel_dielconst.set_defaults(
        handler=dielconst.command_diel_dielconst)
